...
%% Título
\titulo{Bom Gosto - Sistema Web Administrativo para Gestão de Confeitaria}

%% Autor
\autor{Alberto Caetano de Souza,
\\
Ana Vitória Alves de Oliveira,
\\
André Teodoro Machado,
\\
Murillo de Almeida Miranda,
\\
Wendel Henrique Lima de Souza,
\\
Yasmin Gomes de Lima}
...
\orientador{Prof. M\textsuperscript{e}. Marcelo Tavares de Santana}
